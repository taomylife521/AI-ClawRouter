...
function parseArgs(args) {
    ...
    for (let i = 0; i < args.length; i++) {
        ...
        else if ((arg === "chain" || arg === "/wallet" || arg === "wallet") &&
...
async function main() {
    ...
    if (args.doctor) {
        ...
        let model = "sonnet"; // default to cheaper
    ...
    const proxy = await startProxy({
        ...
        onInsufficientFunds: (info) => {
            console.error(`[ClawRouter] Insufficient funds. Balance: ${info.balanceUSD}, Need: ${info.requiredUSD}`);
